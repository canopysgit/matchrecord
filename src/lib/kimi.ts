...
4. 乌龙球标注isOwnGoal为true，scorer填实际踢进乌龙球的球员标准名（不要填"乌龙球"），team填该球员所在队伍。如果没有指明谁踢的乌龙球，scorer填"未知"
5. "白队乌龙"意味着白队球员踢进自己球门，蓝队得分，对应whiteOwnGoals+1。whiteOwnGoals表示白队犯的乌龙球数，blueOwnGoals表示蓝队犯的乌龙球数
